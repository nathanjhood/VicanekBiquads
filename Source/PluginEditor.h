...
/**
*/
class VicanekBiquadAudioProcessorEditor  : public juce::AudioProcessorEditor, public juce::Timer
{
public:
    VicanekBiquadAudioProcessorEditor (VicanekBiquadAudioProcessor&);
    ~VicanekBiquadAudioProcessorEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (VicanekBiquadAudioProcessorEditor)
};
